<template>
  <div class="form-group position-relative">
    ...
    />
    <div v-if="validate_status && errors.length > 0" class="invalid-feedback d-block">
...
export default {
  ...
  computed: {
    ...
    validate_status() {
      if (this.selected_date && this.date =='') {
        return true;
      } else {
        return (this.validator && this.validator.errorCount) || (this.error && this.selected_date);
      }
