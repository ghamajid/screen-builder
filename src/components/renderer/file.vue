<template>
  <div class="uploader-file-new" :status="status">456789
    <slot
      :file="file"
      :list="list"
      :status="status"
      ...
      <div class="uploader-file-info">
        <div class="uploader-file-name"><i class="uploader-file-icon" :icon="fileCategory"></i>{{file.name}}333</div>
        <div class="uploader-file-size">{{formatedSize}}</div>
        <div class="uploader-file-meta"></div>
        <div class="uploader-file-status">4
          <span v-show="status !== 'uploading'">{{statusText}}5</span>
          <span v-show="status === 'uploading'">sda
...
<script>
  ...
  const COMPONENT_NAME = 'uploader-file-new'
...
<style>
  ...
  .uploader-file-new[status="waiting"] .uploader-file-pause,
  .uploader-file-new[status="uploading"] .uploader-file-pause {
    display: block;
  }
  .uploader-file-new[status="paused"] .uploader-file-resume {
    display: block;
  }
  .uploader-file-new[status="error"] .uploader-file-retry {
    display: block;
  }
  .uploader-file-new[status="success"] .uploader-file-remove {
    display: none;
  }
  .uploader-file-new[status="error"] .uploader-file-progress {
    background: #ffe0e0;
  }
