...
import FormMultiSelectOption from './components/renderer/form-multi-select-option';
import Pelak from './components/renderer/pelak';
import FormInput from './components/renderer/form-input';
import FormTextArea from './components/renderer/form-text-area';
import FormCheckbox from './components/renderer/form-checkbox';
import FormHtmlEditor from './components/renderer/form-html-editor';
import FormDatePicker from './components/renderer/form-date-picker';
import FormHtmlViewer from './components/renderer/form-html-viewer';
...
export default [{
    ...
    {
        editorComponent: FormInput,
        editorBinding: 'FormInput',
        rendererComponent: FormRecordList,
        rendererBinding: 'FormRecordList',
        control: {
            label: 'Record List 2',
